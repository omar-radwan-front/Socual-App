...
//     body : z.string().min(1 ," must be at least 1 characters long" ),
...
//   })
  ...
  async function onSubmit(data) {
   ...
   setIsLoading(true) 
    ...
    try {
      ...
      let res=await axios.post(`https://linked-posts.routemisr.com/posts`,mydata,{
        headers:{
  ...
  return (
    <>
      <Button className=" my-2 w-[100%] md:w-fit rounded-2xl" onClick={() => setOpenModal(true)}>Create Post</Button>
